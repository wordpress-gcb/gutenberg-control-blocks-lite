#!/usr/bin/env bash
#
# Build the gcb-abstrak theme zip for the Playground demo.
#
# Run from the plugin root:
#   bash playground/build-theme.sh
#
# Output: playground/dist/gcb-abstrak.zip
...
SOURCE_DIR="examples/themes/gcb-abstrak"
DIST_DIR="playground/dist"
ZIP_NAME="gcb-abstrak.zip"
...
# `gcb-abstrak/...` as a top-level dir (what WP expects).
